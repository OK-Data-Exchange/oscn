...
counties = [
  { name: 'Adair', rms: 'OCIS', fips_code: '001' },
  { name: 'Alfalfa', rms: 'KP', fips_code: '003' },
  { name: 'Atoka', rms: 'KP', fips_code: '005' },
  { name: 'Beaver', rms: 'KP', fips_code: '007' },
  { name: 'Beckham', rms: 'KP', fips_code: '009' },
  { name: 'Blaine', rms: 'KP', fips_code: '011' },
  { name: 'Bryan', rms: 'KP', fips_code: '013' },
  { name: 'Caddo', rms: 'KP', fips_code: '015' },
  { name: 'Canadian', rms: 'OCIS', fips_code: '017' },
  { name: 'Carter', rms: 'KP', fips_code: '019' },
  { name: 'Cherokee', rms: 'KP', fips_code: '021' },
  { name: 'Choctaw', rms: 'KP', fips_code: '023' },
  { name: 'Cimarron', rms: 'KP', fips_code: '025' },
  { name: 'Cleveland', rms: 'OCIS', fips_code: '027' },
  { name: 'Coal', rms: 'KP', fips_code: '029' },
  { name: 'Comanche', rms: 'OCIS', fips_code: '031' },
  { name: 'Cotton', rms: 'KP', fips_code: '033' },
  { name: 'Craig', rms: 'KP', fips_code: '035' },
  { name: 'Creek', rms: 'KP', fips_code: '037' },
  { name: 'Custer', rms: 'KP', fips_code: '039' },
  { name: 'Delaware', rms: 'KP', fips_code: '041' },
  { name: 'Dewey', rms: 'KP', fips_code: '043' },
  { name: 'Ellis', rms: 'OCIS', fips_code: '045' },
  { name: 'Garfield', rms: 'OCIS', fips_code: '047' },
  { name: 'Garvin', rms: 'KP', fips_code: '049' },
  { name: 'Grady', rms: 'KP', fips_code: '051' },
  { name: 'Grant', rms: 'KP', fips_code: '053' },
  { name: 'Greer', rms: 'KP', fips_code: '055' },
  { name: 'Harmon', rms: 'KP', fips_code: '057' },
  { name: 'Harper', rms: 'KP', fips_code: '059' },
  { name: 'Haskell', rms: 'KP', fips_code: '061' },
  { name: 'Hughes', rms: 'KP', fips_code: '063' },
  { name: 'Jackson', rms: 'KP', fips_code: '065' },
  { name: 'Jefferson', rms: 'KP', fips_code: '067' },
  { name: 'Johnston', rms: 'KP', fips_code: '069' },
  { name: 'Kay', rms: 'KP', fips_code: '071' },
  { name: 'Kingfisher', rms: 'KP', fips_code: '073' },
  { name: 'Kiowa', rms: 'KP', fips_code: '075' },
  { name: 'Latimer', rms: 'KP', fips_code: '077' },
  { name: 'Le Flore', rms: 'KP', fips_code: '079' },
  { name: 'Lincoln', rms: 'KP', fips_code: '081' },
  { name: 'Logan', rms: 'OCIS', fips_code: '083' },
  { name: 'Love', rms: 'KP', fips_code: '085' },
  { name: 'Major', rms: 'KP', fips_code: '093' },
  { name: 'Marshall', rms: 'KP', fips_code: '095' },
  { name: 'Mayes', rms: 'KP', fips_code: '097' },
  { name: 'McClain', rms: 'KP', fips_code: '087' },
  { name: 'McCurtain', rms: 'KP', fips_code: '089' },
  { name: 'McIntosh', rms: 'KP', fips_code: '091' },
  { name: 'Murray', rms: 'KP', fips_code: '099' },
  { name: 'Muskogee', rms: 'KP', fips_code: '101' },
  { name: 'Noble', rms: 'KP', fips_code: '103' },
  { name: 'Nowata', rms: 'KP', fips_code: '105' },
  { name: 'Okfuskee', rms: 'KP', fips_code: '107' },
  { name: 'Oklahoma', rms: 'OCIS', fips_code: '109' },
  { name: 'Okmulgee', rms: 'KP', fips_code: '111' },
  { name: 'Osage', rms: 'KP', fips_code: '113' },
  { name: 'Ottawa', rms: 'KP', fips_code: '115' },
  { name: 'Pawnee', rms: 'KP', fips_code: '117' },
  { name: 'Payne', rms: 'OCIS', fips_code: '119' },
  { name: 'Pittsburg', rms: 'KP', fips_code: '121' },
  { name: 'Pontotoc', rms: 'KP', fips_code: '123' },
  { name: 'Pottawatomie', rms: 'KP', fips_code: '125' },
  { name: 'Pushmataha', rms: 'OCIS', fips_code: '127' },
  { name: 'Roger Mills', rms: 'OCIS', fips_code: '129' },
  { name: 'Rogers', rms: 'OCIS', fips_code: '131' },
  { name: 'Seminole', rms: 'KP', fips_code: '133' },
  { name: 'Sequoyah', rms: 'KP', fips_code: '135' },
  { name: 'Stephens', rms: 'KP', fips_code: '137' },
  { name: 'Texas', rms: 'KP', fips_code: '139' },
  { name: 'Tillman', rms: 'KP', fips_code: '141' },
  { name: 'Tulsa', rms: 'OCIS', fips_code: '143' },
  { name: 'Wagoner', rms: 'KP', fips_code: '145' },
  { name: 'Washington', rms: 'KP', fips_code: '147' },
  { name: 'Washita', rms: 'KP', fips_code: '149' },
  { name: 'Woods', rms: 'KP', fips_code: '151' },
  { name: 'Woodward', rms: 'KP', fips_code: '153' }
]
